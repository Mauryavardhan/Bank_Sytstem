/* ===========================================
   ...
   // Add my_getch prototype for cross-platform compatibility
   #ifdef _WIN32
   ...
   void setColor(int color)
   {
       ...
       switch (color) {
           case 7:  printf("\033[0m"); break;   // Reset
           case 10: printf("\033[0;32m"); break; // Green
           case 11: printf("\033[0;36m"); break; // Cyan
           case 12: printf("\033[0;31m"); break; // Red
           case 14: printf("\033[0;33m"); break; // Yellow
   ...
   void displayTitle()
   {
       ...
       cout << "\n\n\t\t**************************************************";
       cout << "\n\t\t*                                                *";
       cout << "\n\t\t*       IIT KGP BANK - Digital Banking System    *";
       cout << "\n\t\t*                                                *";
       cout << "\n\t\t**************************************************\n\n";
       setColor(7);
   }
